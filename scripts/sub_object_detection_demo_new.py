...
checkpoint = f"/content/drive/MyDrive/Angebot/facebook-detr-resnet-101/140epochs_subimages"
number_epochs = 70
...
training_args = TrainingArguments(
    output_dir=f"/content/drive/MyDrive/Angebot/facebook-detr-resnet-101/210epochs_subimages",
...
path_output_ab_ds, path_anno = save_cppe5_annotation_file_images(ab_ds["train"])
